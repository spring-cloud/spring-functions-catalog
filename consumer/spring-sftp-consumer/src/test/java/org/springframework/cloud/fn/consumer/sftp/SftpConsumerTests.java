...
@DirtiesContext
@SpringBootTest(properties = { "sftp.consumer.remoteDir = sftpTarget", "sftp.consumer.factory.username = foo",
		"sftp.consumer.factory.password = foo", "sftp.consumer.mode = FAIL",
